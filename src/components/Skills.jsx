          ...
          <div className="group relative bg-white/[0.04] border border-white/10 rounded-2xl sm:rounded-3xl p-4 sm:p-6 backdrop-blur-2xl hover:border-yellow-400/70 hover:-translate-y-3 hover:shadow-[0_0_35px_rgba(59,130,246,0.12)] transition-all duration-500">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                {
                  name: "REST API",
                  logo: "https://img.icons8.com/fluency/96/api-settings.png",
                },
                {
                  name: "WebSockets",
                  logo: "https://img.icons8.com/color/96/network-card.png",
                },
              ].map((item, index) => (
                <div
                  key={index}
          ...
          <div className="group relative bg-white/[0.04] border border-white/10 rounded-2xl sm:rounded-3xl p-4 sm:p-6 backdrop-blur-2xl hover:border-yellow-400/70 hover:-translate-y-3 hover:shadow-[0_0_35px_rgba(59,130,246,0.12)] transition-all duration-500">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                {
                  name: "Word",
                  logo: "https://img.icons8.com/color/96/microsoft-word-2019--v1.png",
                },
                {
                  name: "PowerPoint",
                  logo: "https://img.icons8.com/color/96/microsoft-powerpoint-2019.png",
                },
                {
                  name: "Vercel",
                ...
                {
                  name: "Render",
                  logo: "https://seeklogo.com/images/R/render-logo-113CDAA5E8-seeklogo.com.png",
                },
              ].map((item, index) => (
                <div
                  key={index}
